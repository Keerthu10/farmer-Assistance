...
class MockDatabase {
  ...
  seed() {
    ...
    // 5. Seed Market Prices with Historical Trends
    ...
    // 7. Seed Assistance Requests & Responses
...
- Zinc Deficiency: Basal broadcast of Zinc Sulphate Heptahydrate 21% @ 25 kg/acre once every 2 years.`,
  ...
  // Weather provider
  getWeatherForDistrict(district: string = 'Ludhiana'): WeatherData {
    const today = new Date();
